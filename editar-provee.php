...
<div id="crear1">
	...
	<form id="edit_prov">
		...
		Tipo de Pago:<br><br>
		<input type="radio" name="pago" id="transfe" value="Transferencia" required>Transferencia     
		<input type="radio" name="pago" id="perso" value="Personal">Personal<br><br>
		<div id="cuenta" style="display: none">
			<input type="text" placeholder="Numero de cuenta" name="cuenta"  ><br>
