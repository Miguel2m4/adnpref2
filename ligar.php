...
<div id="crear1">
	<form id="liga">
		...
		<input type="number" placeholder="Valor del Inmueble" name="valor" id="valor" required="" >
		<input type="text" placeholder="Recargo" name="recargo" id="recargo" required="">
		<input type="number" placeholder="Valor de Administracion" name="admintr" >
		<input type="number" placeholder="Mora Administracion" name="moradmintr" >
</div>
