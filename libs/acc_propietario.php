...
switch ($opc) {
	case 'crear':
		$crea = mysql_query("INSERT INTO propietarios VALUES('$idprop','$nombre','$apellido','$telefono','$movil','$email','$direccion','$pago','$cuenta','$banco') ");
		if($crea==true)
		{
	...
	break;
	case 'editar':
		$act = mysql_query("UPDATE propietarios SET Nom_prop='$nombre',Apel_prop='$apellido',Tel_prop='$telefono',Mov_prop='$movil',Email_prop='$email',Direc_prop='$direccion',Pago_prop='$pago',Cuenta_prop='$cuenta',Banco_prop='$banco'
